...
export default function ProfileContact(props) {
  return (
    <div className="content-profile-contact">
      ...
      <div
        onClick={() => {
          props.setShowPicture({ user: props.user, img: props.img });
        }}
        className="box-profile-contact content-profile-info-user"
      >
        <img
        ...
        <Stat
          ...
          content={
            <p className="no-multimedia">
              Sin archivos multimedia, enlaces ni documentos
            </p>
          }
        />
      </div>
      <div className="box-profile-contact content-stat">
        <p className="center-stat only-action only-action-text hr-bb">
          Silenciar notificaciones
        </p>
        <p className="center-stat only-action only-action-text">
          Mensajes destacados
        </p>
      </div>
      <div className="box-profile-contact">
